...
func TestDSN(t *testing.T) {
	...
	tests := []struct {
		...
		{"simple", args{"acct", "user", "pass", false, "region", "role", "", 443, "https"},
		...
		{"us-west-2 special case", args{"acct2", "user2", "pass2", false, "us-west-2", "role2", "", 443, "https"},
			"user2:pass2@acct2.snowflakecomputing.com:443?ocspFailOpen=true&role=role2&validateDefaultParameters=true", false},
		{"customhostwregion", args{"acct3", "user3", "pass3", false, "", "role3", "zha123.us-east-1.privatelink.snowflakecomputing.com", 443, "https"},
		...
		{"customhostignoreregion", args{"acct4", "user4", "pass4", false, "fakeregion", "role4", "zha1234.us-east-1.privatelink.snowflakecomputing.com", 443, "https"},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := provider.DSN(tt.args.account, tt.args.user, tt.args.password, tt.args.browserAuth, "", "", "", "", tt.args.region, tt.args.role, tt.args.host, tt.args.port, tt.args.protocol)
...
func TestOAuthDSN(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := provider.DSN(tt.args.account, tt.args.user, "", false, "", "", "", tt.args.oauthAccessToken, tt.args.region, tt.args.role, "", 443, "https")
